...
class KalshiAlphaBot:
    ...
    def research_and_validate(self, market):
        ...
        prompt = f"Research this Kalshi market: {title}. Category: {category}. Current odds YES: {yes_prob:.1%}, NO: {no_prob:.1%}. Volume: ${volume:,.0f}. Closes: {close_date}. Use web search to find current information and expert predictions. Provide: BUY YES, BUY NO, or PASS recommendation with HIGH/MEDIUM/LOW confidence and detailed reasoning with sources. Only recommend BUY if there is clear mispricing."
