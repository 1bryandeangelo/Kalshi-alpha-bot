...
2. Find expert predictions, polls, data, historical precedents
3. Identify key factors that will determine the outcome
4. Look for information the market might be missing or mispricing

ANALYZE:
1. What is the TRUE probability of YES based on your research?
2. Is the current market price ({yes_prob:.1%} YES) accurate?
3. Is there a clear mispricing opportunity?
4. What are the key risks or uncertainties?
